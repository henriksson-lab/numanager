...
require_text "$readme_file" "| [Andor SDK2 cameras](docs/devices/andor-sdk2.md) | USB discovery, firmware/runtime package checks, EP0 control helpers, opt-in live Mono16 capture, and vendor-runtime exposure/detector/cooler control | - |" "Andor SDK2 README index row"
require_text "$readme_file" "| [Andor SDK3 cameras](docs/devices/andor-sdk3.md) | USB discovery, hidden FX3 firmware init, EP0 status readback, runtime package checks, vendor-runtime feature control, and Mono16 capture | - |" "Andor SDK3 README index row"
...
require_text "${driver_src_dir}/andor_camera.rs" "SDK2 USB discovery, firmware/runtime package checks, EP0 command helpers, live bulk-IN Mono16 capture behind os-usb, and vendor-runtime exposure, full-frame capture, detector readback, and cooler control" "Andor SDK2 support-level wording"
require_text "${driver_src_dir}/andor_camera.rs" "SDK3 USB discovery, hidden FX3 firmware initialization, confirmed EP0 status readbacks, firmware/runtime package checks, vendor-runtime feature control/readback, cooler control, and capture backend" "Andor SDK3 support-level wording"
